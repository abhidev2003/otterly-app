...
export default function OnboardingPage() {
  ...
  const onSubmit = async (data: any) => {
    if (!user) {
      return alert('You must be logged in to complete onboarding.');
    }

    try {
      // 1. Save user profile information
      ...
      // 2. Save aspirations to the subcollection
